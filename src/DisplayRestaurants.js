            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", height: "300px", overflowY: "scroll", backgroundColor: "gray", borderRadius:"10px"}}>
                {
                    props.restaurants.map((restaurant) => (
                        <div style={{ display: "flex", height: "200px", width: "320px", flexDirection: "column", alignItems: "center", border: "dotted", borderColor: "darkslategray", flexWrap: "wrap", backgroundColor: "darkgray", padding: "10px", margin: "4px", borderRadius: "10px"}}>
